...
class StoreSetting extends Model
{
    ...
    protected $fillable = [
        ...
        'instapay_details_ar',
        'instapay_details_en',
        'coupon_popup_enabled',
        'coupon_popup_title_ar',
        'coupon_popup_title_en',
        'coupon_popup_text_ar',
        'coupon_popup_text_en',
        'coupon_popup_code',
        'coupon_popup_button_label_ar',
        'coupon_popup_button_label_en',
        'coupon_popup_image',
        'coupon_popup_overlay',
        'coupon_popup_delay',
        'coupon_popup_remember_days',
        'whatsapp_button_enabled',
        'whatsapp_button_message_ar',
        'whatsapp_button_message_en',
    ...
    protected $casts = [
        ...
        'coupon_popup_enabled' => 'boolean',
        'coupon_popup_overlay' => 'integer',
        'coupon_popup_delay' => 'integer',
        'coupon_popup_remember_days' => 'integer',
